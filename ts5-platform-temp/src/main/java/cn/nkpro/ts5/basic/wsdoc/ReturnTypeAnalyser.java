...
import cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldListNotes;
...
class ReturnTypeAnalyser {

	static String analyse(Class<?> clazz) {
		return execAnalyse(new HashSet<>(), clazz, 0, null);
	}
	static String analyse(Class<?> clazz, int level, String desc) {
