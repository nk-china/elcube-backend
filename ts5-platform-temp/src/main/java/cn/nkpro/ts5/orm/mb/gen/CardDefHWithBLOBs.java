...
public class CardDefHWithBLOBs extends CardDefH implements Serializable {
    /**
     * 组件的服务类入口
     *
     * @mbggenerated
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("组件的服务类入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("组件的依赖类集合")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("组件的数据界面入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("组件的配置界面入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("组件的依赖界面组件集合")
