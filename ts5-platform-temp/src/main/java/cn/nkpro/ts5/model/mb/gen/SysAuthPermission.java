...
public class SysAuthPermission implements Serializable {
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("资源，如单据 D:ZR01 ")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("操作 CRUD")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("限制，主要针对数据权限控制")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.basic.wsdoc.annotation.CodeFieldNotes("子资源，如卡片")
