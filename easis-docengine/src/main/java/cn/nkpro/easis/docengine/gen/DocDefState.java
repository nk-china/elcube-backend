...
public class DocDefState extends DocDefStateKey implements Serializable {
     ...
     * @mbggenerated
     */
    @cn.nkpro.easis.annotation.CodeFieldNotes("业务逻辑处理类")
     ...
     * @mbggenerated
     */
    @cn.nkpro.easis.annotation.CodeFieldNotes("0 不可编辑，1 可编辑，2 流程中可编辑")
     ...
     * @mbggenerated
     */
    @cn.nkpro.easis.annotation.CodeFieldNotes("ACTIVATE, CANCEL")
     ...
     * @mbggenerated
     */
    @cn.nkpro.easis.annotation.CodeFieldNotes("操作名")
