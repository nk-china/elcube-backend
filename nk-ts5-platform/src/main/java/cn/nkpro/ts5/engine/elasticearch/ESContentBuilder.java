...
class ESContentBuilder {
    ...
    ESDocument parseDocument(Class<? extends AbstractESDoc> esType){
    ...
    String parseDocId(AbstractESDoc doc){
        Class<? extends AbstractESDoc> esType = doc.getClass();
    ...
    XContentBuilder buildMapping(Class<? extends AbstractESDoc> esType) throws IOException {
