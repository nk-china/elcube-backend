...
//    }
    ...
    @Override
    @Transactional
    public PlatformScript doRun(PlatformScriptV scriptDefH, boolean run){
    ...
    @Override
    @Transactional
    public PlatformScript doBreach(PlatformScriptV scriptDefH){
    ...
    @Override
    @Transactional
    public PlatformScript doUpdate(PlatformScriptV scriptDefH, boolean force){
    ...
    @Override
    @Transactional
    public void doDelete(PlatformScriptV scriptDefH){
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        if(contextRefreshedEvent.getApplicationContext()== debugContextManager.getApplicationContext()){
            getActiveResources().forEach((scriptDef)-> {
                try {
                    debugContextManager.addActiveResource("#"+scriptDef.getScriptName(), BeanUtilz.copyFromObject(scriptDef, PlatformScriptV.class));
