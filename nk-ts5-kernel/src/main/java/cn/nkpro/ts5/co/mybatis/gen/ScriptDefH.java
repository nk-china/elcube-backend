...
public class ScriptDefH extends ScriptDefHKey implements Serializable {
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.wsdoc.annotation.CodeFieldNotes("组件描述")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.wsdoc.annotation.CodeFieldNotes("Active Version, boolean Value, 1 or 0")
     ...
     * @mbggenerated
     */
    @cn.nkpro.ts5.wsdoc.annotation.CodeFieldNotes("ref User ID")
