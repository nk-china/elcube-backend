...
public class PlatformScriptWithBLOBs extends PlatformScript implements Serializable {
     ...
     * @mbggenerated
     */
    @cn.nkpro.elcard.annotation.CodeFieldNotes("组件的服务类入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.elcard.annotation.CodeFieldNotes("组件的依赖类集合")
     ...
     * @mbggenerated
     */
    @cn.nkpro.elcard.annotation.CodeFieldNotes("组件的数据界面入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.elcard.annotation.CodeFieldNotes("组件的配置界面入口")
     ...
     * @mbggenerated
     */
    @cn.nkpro.elcard.annotation.CodeFieldNotes("组件的依赖界面组件集合")
