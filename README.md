...
ELCard 由EL（表达式语言）和Card（卡片）两个词组合而成，寓意着企业级的复杂系统的实现可以用很简单的方式，
...
ELCard 遵照AGPL-3.0协议开放源代码，在遵照协议约束条件下，您可以自由传播和修改。
...
ELCard发源自纽扣互联内部TS5项目，原本是为融资租赁行业行业开发的行业级解决方案，
...
因此，ELCard面向的，是开发人员，而不是面向业务人员的低代码平台。我们定位自己为企业级的软件开发范式。
...
ELCard是专门为企业级复杂系统而生的技术平台。它具备低代码开发平台的大部分特性，
...
ELCard业务流，是单据引擎的一部分，负责将多个单据，根据业务规则串成一个流程图；
...
### 使用概要
ELCard Backend 为ELCard模型的服务端部分，需要配合ELCard的WEB前端服务一起使用

相关链接：

[ELCard 演示系统-搭建中]

[ELCard 指南-逐步完善中](http://docs.elcard.nkpro.cn/guide/)

[ELCard Front Gitee仓库](https://gitee.com/newcorenet/elcard-front)

[ELCard Front Github仓库](https://github.com/nk-china/elcard-front)
