...
public class DocDefFlow extends DocDefFlowKey implements Serializable {
    ...
    private String refObjectParams;
    ...
    @cn.nkpro.elcube.annotation.CodeFieldNotes("")
    public String getRefObjectParams() {
        return refObjectParams;
    }

    public void setRefObjectParams(String refObjectParams) {
        this.refObjectParams = refObjectParams;
    }
}